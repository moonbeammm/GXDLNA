...
#ifndef GXDLNAMediaController_hpp
#define GXDLNAMediaController_hpp

#import "PltLeaks.h"
#import "PltDownloader.h"
#import "Platinum.h"
#import "PltMediaServer.h"
#import "PltSyncMediaBrowser.h"
...
public:
    ...
    PLT_MicroMediaController(PLT_CtrlPointReference& ctrlPoint,GXDLNADMControl * delegateWrapper);
...
//    const PLT_StringMap getMediaServersNameTable();
    const NPT_Lock<PLT_DeviceMap> getMediaRenderersNameTable();
...
//    PLT_DeviceDataReference getCurrentMediaServer();
    ...
    void    sendSeekCommand(NPT_UInt64 seek);
...
#endif /* GXDLNAMediaController_hpp */
